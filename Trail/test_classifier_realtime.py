...
LSTM_MODEL_PATH = 'lstm_classifier_5_words.pth' # The model we just trained
...
SEQUENCE_LENGTH = 54 # Length of sequence to feed to LSTM
CONF_THRESHOLD = 0.4 # Confidence threshold for displaying a prediction
